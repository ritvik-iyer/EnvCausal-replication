...
The last column of table 8 reports a regression with all the treatment variables as covariates. In a naive sense, the coefficient for  "TEMP" may be interpreted as the effect of temperature on the number of COVID-19 cases, controlling for different environmental, demographic, and economical factors. However, this column are fundamentally impossible to intrepret as the variables interchange between being a covariate and a treatment, which is impossible given that a varibale cannot be both a covariate and a treatment simultaneously.
